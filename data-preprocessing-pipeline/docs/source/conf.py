...
# data_preprocessing_pipeline documentation build
...
from data_preprocessing_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "data_preprocessing_pipeline"
author = "Kedro"
...
htmlhelp_basename = "data_preprocessing_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "data_preprocessing_pipeline.tex",
        "data_preprocessing_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "data_preprocessing_pipeline",
        "Project data_preprocessing_pipeline codebase.",
        "Data-Science",
    )
]
