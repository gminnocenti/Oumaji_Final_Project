...
# azurepipelinedeployment documentation build
...
from azurepipelinedeployment import __version__ as release

# -- Project information -----------------------------------------------------

project = "azurepipelinedeployment"
author = "Kedro"
...
htmlhelp_basename = "azurepipelinedeploymentdoc"
...
latex_documents = [
    (
        master_doc,
        "azurepipelinedeployment.tex",
        "azurepipelinedeployment Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "azurepipelinedeployment",
        "Project azurepipelinedeployment codebase.",
        "Data-Science",
    )
]
